...
const allowedCodes = new Set(["ORIGINAL_ANUAL_PROYECTADO", "FORECAST_REVISADO"]);
...
export function BudgetTypesPage() {
  ...
  return <div className="page-stack phase11-page">
    <section className="page-heading"><div><span className="eyebrow">Paso 3 · Modalidad presupuestal</span><h1>Tipos de presupuesto</h1><p>Seleccione si trabajará el presupuesto original anual con proyección a tres años o el presupuesto revisado forecast. Los componentes del presupuesto maestro se muestran en una opción separada después de Tablas maestras.</p></div><span className="status-pill status-pill--success"><Layers3 size={16} /> Contexto obligatorio</span></section>
    ...
    <section className="phase11-selection-card panel">
      ...
      <p className="muted">Esta selección define si la información maestra corresponde al presupuesto original o al presupuesto revisado forecast.</p>
    </section>
